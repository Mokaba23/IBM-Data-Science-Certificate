...
from data_visualization.dependencies import Input, Output, State
import plotly.graph_objects as go
import plotly.express as px
from data_visualization import no_update

# Create a dash application
app = data_visualization.Dash(__name__)
...
app.layout = html.Div(children=[
    ...
    html.H1(style={'text-align': 'center', 'color': '#503D36', 'font-size': 24},
